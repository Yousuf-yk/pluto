...
const Cart = () => {
  ...
  /*
   * Find the current product from the products table.
   *
   * Depending on your cart API response, the product ID may be
   * available as product_id or productId.
   */
            ...
            <div className="relative overflow-hidden rounded-[24px] border border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-16 text-center shadow-[var(--shadow-md)] sm:px-10 sm:py-20">
              ...
              <div className="relative z-10">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-[var(--color-text-muted)]">
                  Nothing here yet. Explore our latest sneaker collection and
                  find your next pair.
                </p>

                <Link
                  to="/"
                  className="mt-8 inline-flex items-center gap-2 rounded-[12px] bg-[var(--color-primary)] px-6 py-3 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-[var(--color-primary-hover)]"
                >
                  Continue shopping
                  <ArrowRight size={16} />
                </Link>
                ...
                <div className="overflow-hidden rounded-[20px] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-sm)]">
                  ...
                  {cart.map((item, index) => {
                    ...
                    const remainingStock =
                      stock !== null
                        ? Math.max(stock - item.quantity, 0)
                        : null;
                    ...
                    return (
                      ...
                      >
                          ...
                          <div className="mt-4 flex items-center justify-between gap-4 sm:mt-5">
                            ...
                            <div className="inline-flex items-center overflow-hidden rounded-[10px] border border-[var(--color-border)] bg-[var(--color-background-secondary)]">
                              ...
                              <button
                                ...
                                className="flex h-9 w-9 items-center justify-center text-[var(--color-text-secondary)] transition hover:bg-[var(--color-surface)] hover:text-[var(--color-primary)] disabled:cursor-not-allowed disabled:opacity-30"
                              >
                                <Plus size={15} />
                              </button>
                        ...
                        {/* DESKTOP PRICE */}
                        <div className="hidden min-w-[100px] shrink-0 text-right md:block">
              ...
              <aside className="lg:sticky lg:top-24">
                ...
                <div className="overflow-hidden rounded-[20px] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-md)]">
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    {/* CHECKOUT */}
                    <button className="group mt-6 flex w-full items-center justify-center gap-2 rounded-[12px] bg-[var(--color-primary)] py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--color-primary-hover)]">
                      Proceed to checkout
                  ...
                  <div className="border-t border-[var(--color-border)] bg-[var(--color-background-secondary)] px-5 py-4">
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <p className="text-[10px] font-medium leading-4 text-[var(--color-text-muted)]">
                        Secure checkout · Your payment information is
                        protected.
                      </p>
